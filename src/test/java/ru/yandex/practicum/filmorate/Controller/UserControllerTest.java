...
public class UserControllerTest {
    ...
    public void postUserWithoutEmail() {
        user = User.builder()
                ...
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserWithoutEmailException.class, () -> uc.createUser(user), "Добавлен пользователь " + user.getLogin());
    }

    @Test
    public void postUserBadEmail() {
        user = User.builder()
                .email("testUser.yandex.ru")
                .login("testLogin")
                .name("testName")
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserBadEmailException.class, () -> uc.createUser(user), "Добавлен пользователь " + user.getLogin());
    }

    @Test
    public void postWithoutLoginUser() {
        user = User.builder()
                .email("testUser@yandex.ru")
                .name("testName")
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserWithoutLoginException.class, () -> uc.createUser(user), "Добавлен пользователь " + user.getLogin());
    }
    ...
    public void postBadBirthdayUser() {
        user = User.builder()
                ...
                .build();
        assertThrows(UserBadBirthdayException.class, () -> uc.createUser(user), "Добавлен пользователь " + user.getLogin());
    }

    @Test
    public void postNowBirthdayUser() {
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
    ...
    @Test
    public void postAlreadyExistIDUser() {
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
    ...
    @Test
    public void putUserWithoutEmail(){
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
        ...
        User user2 = User.builder()
                ...
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserWithoutEmailException.class,()->uc.updateUser(user2),"Пользователь c ID=" +
                user2.getId()+ " обновлен");
    }

    @Test
    public void putUserWithBadEmail(){
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
        ...
        User user2 = User.builder()
                ...
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserBadEmailException.class,()->uc.updateUser(user2),"Пользователь c ID=" +
                user2.getId()+ " обновлен");
    }

    @Test
    public void putWithoutLoginUser(){
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
        ...
        User user2 = User.builder()
                ...
                .birthday(LocalDate.of(2000, 10, 10))
                .build();
        assertThrows(UserWithoutLoginException.class,()->uc.updateUser(user2),"Пользователь c ID=" +
                user2.getId()+ " обновлен");
    }
    ...
    @Test
    public void putBadBirthdayUser(){
        user = User.builder()
                .email("testUser@yandex.ru")
                .login("testLogin")
                .name("testName")
        ...
        User user2 = User.builder()
                ...
                .login("testLoginUpdate")
                .name("testNameUpdate")
                .birthday(LocalDate.of(2030, 10, 10))
                .build();
        assertThrows(UserBadBirthdayException.class,()->uc.updateUser(user2),"Пользователь с ID="+
                user2.getId() + " обновлен");
    }
